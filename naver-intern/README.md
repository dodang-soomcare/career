...
2. **Elasticsearch 매핑 정보 설계**
   ...
   1. Elasticsearch 매핑 정보를 설정한 이유는?
      ...
      * 인덱스 매핑 정보 설계 결과
        ...
        <img src="./images/1-2-1.png" alt="20221228174722041" style="zoom:25%;" />
...
3. **Elasticsearch 샤드 개수, 레플리카 개수 설계 및 성능 검증**
   ...
   2. 성능 검증은 어떻게 했는지?
      ...
      * 성능 검증 결과 - ***5개가 10개일때보다 성능이 향상된 것을 보여 샤드 5개로 설정***
        ...
        <img src="./images/1-2-2.png" alt="image-20221228180007425" style="zoom:50%;" />
   ...
   1. 어떻게 구현할까?
      ...
      1. Elasticsearch 인덱스 집계 모듈을 코틀린으로 구현
         ...
         * 구현 코드
           ...
           ![image-20221228193401773](./images/2-2-3.png)

      2. 집계 모듈 만들 때 다른 곳에서도 사용이 가능하도록 ***(범용적으로 사용할 수 있도록)*** 재귀로 구현

         ![image-20221228192304036](./images/2-2-4.png)
...
4. **Mongo DB에 저장된 데이터를 집계하여 React로 Custom BI Tool을 구현**
   ...
   3. 성능 테스트 및 튜닝 작업 진행
      ...
      * 결과 - ***평균 4 ~ 9 초 걸리는 집계 쿼리를 50 밀리세컨드로 속도 향상 (160배 향상) ***
